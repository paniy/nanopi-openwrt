...
sed -i 's,default n,default y,g' package/lean/luci-app-passwall/Makefile
sed -i '/V2ray:v2ray/d' package/lean/luci-app-passwall/Makefile
sed -i '/plugin:v2ray/d' package/lean/luci-app-passwall/Makefile
